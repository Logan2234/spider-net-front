  ...
  <Modal bind:open={modalOpen}>
    ...
    {#snippet content()}
      <div class="flex flex-col items-center justify-center gap-4">
        <p>
          Ceci est une modal. Vous pouvez fermer la modale en cliquant sur la croix en haut a
          droite.
        </p>
      </div>
    {/snippet}
    ...
    {#snippet footer()}
      <Button label="Fermer" color="secondary" type="button" onclick={() => (modalOpen = false)} />
    {/snippet}
  </Modal>
</div>
